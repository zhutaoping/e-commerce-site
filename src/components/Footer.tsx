...
const Footer = () => {
  return (
    <div className="fade-in bg-dark py-5 text-light">
      <Container fluid="xxl">
        <Row className="gy-5 justify-">
          <Col md={6} lg={4} className="ps-md-5">
            <h2 className="text-center text-md-start fs-5">Mock</h2>
          ...
          <Col
            ...
            lg={4}
          >
            <div className="d-flex align-items-center gap-4 footer-nav fs-6">
              <Nav.Link as={Link} to="/">
                <span>Home</span>
              </Nav.Link>
              <span>|</span>
          ...
          >
            <h4 className="mb-3 fs-5">Contact</h4>
